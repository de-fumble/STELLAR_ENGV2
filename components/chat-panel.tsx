...
export function ChatPanel({ messages, query }: ChatPanelProps) {
  ...
  return (
    <div className="fixed bottom-[-200em] left-0 right-0 top-10 mx-auto h-screen flex flex-col items-center justify-center">
    <div className="imgs"> 
    <svg
    fill="currentColor"
    viewBox="0 0 768 768"
  ...
  >
    <image href="https://imagizer.imageshack.com/img924/3430/Co3r0Q.png" x="0" y="0" width="768" height="768" />
  </svg>
